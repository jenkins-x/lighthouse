...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/lighthouse/main/101'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse:1.33.11'
