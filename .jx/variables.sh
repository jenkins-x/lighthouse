...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/lighthouse/main/82'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse:1.25.9'
