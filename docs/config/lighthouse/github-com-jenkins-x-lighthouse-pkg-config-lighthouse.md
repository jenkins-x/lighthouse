...
| `log_level` | string | No | LogLevel enables dynamically updating the log level of the<br />standard logger that is used by all lighthouse components.<br /><br />Valid values:<br /><br />"trace", "debug", "info", "warn", "warning", "error", "fatal", "panic"<br /><br />Defaults to "info". |
