...
- [LighthouseBreakpoint](#LighthouseBreakpoint)
- [LighthouseBreakpointSpec](#LighthouseBreakpointSpec)
- [LighthouseJob](#LighthouseJob)
- [LighthouseJobSpec](#LighthouseJobSpec)
- [LighthouseJobStatus](#LighthouseJobStatus)
- [LighthousePipelineFilter](#LighthousePipelineFilter)
...
| `spec` | [LighthouseBreakpointSpec](./github-com-jenkins-x-lighthouse-pkg-apis-lighthouse-v1alpha1.md#LighthouseBreakpointSpec) | No |  |
...
| Stanza | Type | Required | Description |
|---|---|---|---|
| `filter` | [LighthousePipelineFilter](./github-com-jenkins-x-lighthouse-pkg-apis-lighthouse-v1alpha1.md#LighthousePipelineFilter) | No | Filter filters which kinds of pipeilnes to apply this debug to |
| `debug` | [TaskRunDebug](./github-com-tektoncd-pipeline-pkg-apis-pipeline-v1.md#TaskRunDebug) | No | Debug the debug configuration to apply |
...
| `pipeline_run_spec` | *[PipelineRunSpec](./github-com-tektoncd-pipeline-pkg-apis-pipeline-v1.md#PipelineRunSpec) | No | PipelineRunSpec provides the basis for running the test as a Tekton Pipeline<br />https://github.com/tektoncd/pipeline |
...
|---|---|---|---|
| `type` | [PipelineKind](./github-com-jenkins-x-lighthouse-pkg-config-job.md#PipelineKind) | No | Type is the type of job and informs how<br />the jobs is triggered |
| `owner` | string | No | Owner is the git organisation or user that owns the repository |
| `repository` | string | No | Repository the name of the git repository within the owner |
| `branch` | string | No | Branch the name of the branch |
| `context` | string | No | Context the name of the context |
| `task` | string | No | Task the name of the task |
