...
| EnableReportCompletionDuration | `enable_report_completion_duration` | bool     | No       | when enabled, display completion duration in report status in the SCM provider based on StartTime and CompletionTime of the PipelineActivity.                                                                                         |
