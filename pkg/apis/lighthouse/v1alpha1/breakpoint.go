...
type LighthouseBreakpointSpec struct {
	...
	Debug pipelinev1beta1.TaskRunDebug `json:"debug,omitempty"`
}
...
func (f *LighthousePipelineFilter) ResolveDebug(breakpoints []*LighthouseBreakpoint) *pipelinev1beta1.TaskRunDebug {
