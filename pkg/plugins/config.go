...
type Trigger struct {
	...
	// EnableReportCompletionDuration when enabled, display completion duration in report status in the SCM provider
	// based on StartTime and CompletionTime of the PipelineActivity.
	EnableDisplayReportCompletionDuration bool `json:"enable_display_report_completion_duration,omitempty"`
}
