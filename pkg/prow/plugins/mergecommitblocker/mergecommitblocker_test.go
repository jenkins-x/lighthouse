...
func (f *fakeGHClient) GetIssueLabels(org, repo string, number int) ([]scm.Label, error) {
...
func (f *fakeGHClient) ListIssueComments(org, repo string, number int) ([]scm.Comment, error) {
